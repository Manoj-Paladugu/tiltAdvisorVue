...
<!--          </b-dropdown>-->
          ...
          <div>
            <b-form-select v-model="categoryOptionSelected" :options="categoryOptions" @input="updateSearch"></b-form-select>
          </div>

          <div>
            <b-form-select v-model="minStarOptionSelected" :options="minStarOptions" @input="updateSearch"></b-form-select>
          </div>

          <div>
            <b-form-select v-model="maxCostOptionSelected" :options="maxCostOptions" @input="updateSearch"></b-form-select>
          </div>

<!--          <b-dropdown id="startRating-buttons" text="Select Min Star Rating:" class="m-2" onclick="this.getVenues()"-->
<!--          >-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMinStarRating(1)"> > 1 </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMinStarRating(2)"> > 2  </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMinStarRating(3)"> > 3  </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMinStarRating(4)"> > 4  </b-dropdown-item-button>-->
<!--          </b-dropdown>-->

<!--          <b-dropdown id="costRating-buttons" text="Cost Rating:" class="m-2" onclick="this.getVenues()"-->
<!--          >-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMaxCostRating(0)">  Free  </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMaxCostRating(1)">  $ </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMaxCostRating(2)">  $$  </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMaxCostRating(3)">  $$$  </b-dropdown-item-button>-->
<!--            <b-dropdown-item-button v-on:click="getVenuesByMaxCostRating(4)">  $$$$  </b-dropdown-item-button>-->
<!--          </b-dropdown>-->
