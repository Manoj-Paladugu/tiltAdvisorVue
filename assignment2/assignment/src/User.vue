  ...
  export  default {
    ...
    methods : {
      deleteProfileImage : function() {
        this.$http.delete('http://68.183.162.185:4941/api/v1/users/' + this.$route.params.id + '/photo', {
          headers: {
      ...
      editProfileImage : function(e) {
        ...
        this.$http.put('http://68.183.162.185:4941/api/v1/users/' + this.$route.params.id + '/photo', this.profilePhoto, {
          headers: {
      ...
      getProfilePhoto : function() {
        ...
        this.$http.get('http://68.183.162.185:4941/api/v1/users/' + this.$route.params.id + '/photo')
          .then( (response) => {
            if (response.status === 200) {
              // alert("here");
              this.currentPhoto = 'http://68.183.162.185:4941/api/v1/users/' + this.$route.params.id + '/photo'
            }
          }, function (error) {
      ...
      editUserProfile : function() {
        ...
        if (this.oldPasswordValidation) {
          // alert("here2");
          this.$http.patch('http://68.183.162.185:4941/api/v1/users/' + this.$route.params.id, {
      ...
      getUserInfo : function () {
        ...
        this.$http.get('http://68.183.162.185:4941/api/v1/users/' + this.$route.params.id,{
          headers: {
            'Content-Type': 'application/json',
            'X-Authorization': this.$cookie.get('authToken')
          }
